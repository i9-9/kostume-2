...
const menuItems = [
  { href: "47aw24/", label: "#47AW24" },
  { href: "descubrir1/", label: "#46SS24" },
  { href: "hmen/", label: "MEN" },
  { href: "women/", label: "WOMEN" },
  { href: "wild-object/", label: "WILD OBJECT" },
  { href: "re-con-figure/", label: "RE.CON.FIGURE" },
  { href: "peces-raros-kostume/descubrir-pr-k/", label: "PECES RAROS" },
];
